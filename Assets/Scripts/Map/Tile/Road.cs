...
public class Road : GenericTileLayer {
    ...
    public override void Start() {
        ...
        // Meshes where generated in the base, now do road specific stuff
        MeshRenderer renderer = GetComponent<MeshRenderer>();

        // Load and assign the water material
        Material mat = Resources.Load("Materials/Road", typeof(Material)) as Material;
